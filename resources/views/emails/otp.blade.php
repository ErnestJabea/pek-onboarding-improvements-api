                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                ...
                                                                                                <table cellpadding="0"
                                                                                                    cellspacing="0"
                                                                                                    style="background-color:#f0f3ff;border-radius:10px">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td
                                                                                                                style="font-size:36px;letter-spacing:6px;font-weight:bold;color:#491d00;padding:18px 28px;text-align:center">
                                                                                                                {{ $code }}
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                ...
                                                                                                Ne partagez jamais ce
                                                                                                code avec qui que ce
                                                                                                soit.</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td
